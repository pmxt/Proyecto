...
@section('content')
    <div class="container">
        ...
        <div class="mb-3 d-flex justify-content-between">
            <a href="{{ route('comadronas.ingresarAnio') }}" class="btn btn-info">Ingresar Año</a>
            <a href="{{ route('comadronas.ingresarMes', ['anio' => $anioSeleccionado]) }}" class="btn btn-info">Ingresar Mes</a>
        </div>
        <form method="GET" action="{{ route('comadronas.grafica') }}">
        ...
        <h2 class="text-center">Gráfica de partos atendidos por comadronas</h2>
        ...
        <form action="" method="POST">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>No. partos atendidos por comadrona</td>
