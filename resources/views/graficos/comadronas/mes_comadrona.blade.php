...
@section('content')
<div class="container">
    <h2>Ingresar Datos del Mes para el Año {{ $anio }} - Comadronas</h2>

    <!-- Formulario para ingresar los datos del mes -->
    <form action="{{ route('comadronas.guardarMes') }}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            <label for="partos_atendidos" class="form-label">Número de partos atendidos</label>
