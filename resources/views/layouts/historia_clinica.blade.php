                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            {{ old('diabetes', isset($datos['diabetes']) && $datos['diabetes'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="diabetes" value="no" 
                            {{ old('diabetes', isset($datos['diabetes']) && $datos['diabetes'] == 'no' ? 'checked' : '') }} required> 
                        </td>
                    </tr>
                    <tr>
                        <td>21</td>
                        ...
                        <td>
                            ...
                            {{ old('renal', isset($datos['renal']) && $datos['renal'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="renal" value="no" 
                            {{ old('renal', isset($datos['renal']) && $datos['renal'] == 'no' ? 'checked' : '') }} required> 
                        </td>
                    </tr>
                    <tr>
                        <td>22</td>
                        ...
                        <td>
                            ...
                            {{ old('corazon', isset($datos['corazon']) && $datos['corazon'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="corazon" value="no" 
                            {{ old('corazon', isset($datos['corazon']) && $datos['corazon'] == 'no' ? 'checked' : '') }} required> 
                        </td>
                    </tr>
                    <tr>
                        <td>23</td>
                        ...
                        <td>
                            ...
                            {{ old('hipertension', isset($datos['hipertension']) && $datos['hipertension'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="hipertension" value="no" 
                            {{ old('hipertension', isset($datos['hipertension']) && $datos['hipertension'] == 'no' ? 'checked' : '') }} required> 
                        </td>
                    </tr>
                    <tr>
                        <td>24</td>
                        ...
                        <td>
                            ...
                            {{ old('drogas', isset($datos['drogas']) && $datos['drogas'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="drogas" value="no" 
                            {{ old('drogas', isset($datos['drogas']) && $datos['drogas'] == 'no' ? 'checked' : '') }} required> 
                        </td
                    </tr>
                    <tr>
                        <td>25</td>
                        ...
                        <td>
                            ...
                            {{ old('otra', isset($datos['otra']) && $datos['otra'] == 'si' ? 'checked' : '') }} required> 
                        </td>
                        <td>
                            <input type="radio" name="otra" value="no" 
                            {{ old('otra', isset($datos['otra']) && $datos['otra'] == 'no' ? 'checked' : '') }} required> 
                        </td>
                    </tr>
                </tbody>
            </table>
